...
def adf_test(series, significance_level=0.01):
    """
    ...
    try:
        # Suppress warnings from adfuller
        ...
        # Handle cases where the series is constant or too short
        print(f"ADF test could not be performed: {ve}")
        print("====================\n")
        return False, None, None, None  # Assume non-stationary if test couldn't be performed
