...
# # Usage
# csv_file = '/Users/ru/Polymarket/Whittaker/markets_data.csv'  # Replace with your actual file path
...
# Usage
csv_file = '/Users/ru/Polymarket/Whittaker/markets_data.csv'
output_json_file = '/Users/ru/Polymarket/Whittaker/markets_data.json'
create_market_lookup(csv_file, output_json_file)


# Usage examples
# # print(query_description_by_keyword('market_lookup.json', 'Trump'))
# print(get_market_slug_by_condition_id('/Users/ru/Polymarket/Whittaker/markets_data.csv',
